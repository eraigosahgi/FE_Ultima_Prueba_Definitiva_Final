...
namespace Microsoft.Xades
{
	...
	public class SignaturePolicyId
	{
		...
		public SignaturePolicyId()
		{
            ...
            this.sigPolicyId = new ObjectIdentifier("xades:SigPolicyId"); //adiciones esto en lugar de la anterior JOSE CARLOS
		...
		public XmlElement GetXml()
		{
            ...
            retVal = creationXmlDocument.CreateElement(XadesSignedXml.XmlXadesPrefix,"SignaturePolicyId", XadesSignedXml.XadesNamespaceUri); //se agrego en lugar delo otro JOSE CARLOS
