...
namespace Microsoft.Xades
{
	...
	public class SignaturePolicyIdentifier
	{
		...
		public XmlElement GetXml()
		{
            ...
            retVal = creationXmlDocument.CreateElement(XadesSignedXml.XmlXadesPrefix,"SignaturePolicyIdentifier", XadesSignedXml.XadesNamespaceUri);//esta linea se agrego en ves de la anterior
