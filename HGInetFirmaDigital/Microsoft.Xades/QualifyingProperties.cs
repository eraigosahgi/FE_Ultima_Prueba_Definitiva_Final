...
namespace Microsoft.Xades
{
	...
	public class QualifyingProperties
	{
		...
		public XmlElement GetXml()
		{
            ...
            //JOSE CARLOS ACA ES DONDE SE VERIA LO DEL 141
            ...
            retVal.SetAttribute("xmlns:xades141", XadesSignedXml.XadesNamespace141Uri); //JOSE CARLOS AGRUEGUE ESTA LINEA PARA EL FORMATO COLOMBIANO
            if (!String.IsNullOrEmpty(this.id))
			{
