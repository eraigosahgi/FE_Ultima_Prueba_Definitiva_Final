...
namespace FirmaXadesNet.Signature.Parameters
{
    ...
    public class SignatureParameters
    {
        ...
        public string SigningDateCadena { get; set; } //agruegue esto para que ajustar el formato
        
        //parametros en caso los valores del issuername no sean los que genere c# y vengan de otro lado
        public string DatoIssuername { get; set; }
        public string DatoIssuername1 { get; set; }
        public string DatoIssuername0 { get; set; }
        public string cdesdealmacen { get; set; } //si tien dato si significa que se firma con certificado desde almacen
        public X509Certificate2 certificadoalmacen { get; set; }
        ...
        public string cNombreCertificado { get; set; }
