...
namespace HGICtrlUtilidades
{
	public static class Cl_Texto
	{
		...
		public static bool ValidarExpresion(TipoExpresion expresion, string texto)
		{
			...
			switch (expresion)
			{
				...
				case TipoExpresion.Decimal:
					Regex IsDecimal =
						new Regex(
							@"^(0|([1-9][0-9]*))(\.\d\d$)$"); //new Regex(@"^(0|([1-9][0-9]*))([.][0-9]{2})?$"); 
		...
		public static string NumeroCelular(string numero_celular, int codigo_pais)
		{
			...
			{
				if (ValidarExpresion(TipoExpresion.Numero, numero_celular) &&
					ValidarExpresion(TipoExpresion.Celular, numero_celular))
				{
					if (codigo_pais > 0)
					{
