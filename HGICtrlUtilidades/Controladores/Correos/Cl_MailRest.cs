	...
	{       /// <summary>
		...
		public static List<MensajeEnvioSms> EnviarSms(string UrlApi, string Serial, string Identificacion, List<MensajeContenidoSms> mensajes, string Aplicacion = "")
		{
			...
			try
			{
				...
				Cl_ClienteRest<List<MensajeEnvioSms>> cliente = new Cl_ClienteRest<List<MensajeEnvioSms>>(string.Format("{0}/api/EnviarSms", UrlApi), TipoContenido.Applicationjson.GetHashCode(), "");
				try
				{
					enviar = cliente.POST(MensajeContenidoGlobal);
					if (enviar != null)
		...
		{   // valida la URL del servicio web
			...
			{
				string enviar = null;
				Cl_ClienteRest<string> cliente = new Cl_ClienteRest<string>(UrlApi, TipoContenido.Applicationjson.GetHashCode(), "");
				try
				{
					enviar = cliente.POST("");
					if (enviar != null)
		...
		public static MensajeResumen Obtener(string UrlApi, string Serial, string Identificacion, long IdMensaje)
		{
			// valida la URL del servicio web
			// UrlApi = string.Format("{0}{1}", Ctl_Utilidades.ValidarUrl(UrlApi), UrlWcf);
			...
			try
			{
				...
				Cl_ClienteRest<MensajeResumen> cliente = new Cl_ClienteRest<MensajeResumen>(string.Format("{0}/api/ObtenerResumenMensaje", UrlApi), TipoContenido.Applicationjson.GetHashCode(), "");
				try
				{
