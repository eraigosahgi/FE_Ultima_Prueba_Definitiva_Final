	...
	public class Ctl_Empresa : BaseObject<TblEmpresas>
	{
		...
		public TblEmpresas Editar(TblEmpresas empresa, bool Administrador, List<ObjVerificacionEmail> ListaEmailRegistro)
		{
			...
			try
			{
				...
				EmpresaActualiza.IntAcuseTacito = (empresa.IntAcuseTacito > 0 && empresa.IntAcuseTacito < 72) ? EmpresaActualiza.IntAcuseTacito : empresa.IntAcuseTacito; //empresa.IntAcuseTacito;
				...
				//***Se deshabilita por instruccion de gerencia, para Radian el cliente debe tener Certificado propio
