								...
								for (int i = 0; i < item_row.ItemArray.Count(); i++)
								{
									switch (i)
									{
										...
										case 9:
											...
											break;
										case 10:
											import.IntVlrIva = Convert.ToDecimal(item_row[i].ToString().Replace(".",","));
											break;
										case 11:
											import.IntVlrIca = Convert.ToDecimal(item_row[i].ToString().Replace(".", ","));
											break;
										case 12:
											import.IntVlrIPC = Convert.ToDecimal(item_row[i].ToString().Replace(".", ","));
											break;
										case 13:
											import.IntVlrTotal = Convert.ToDecimal(item_row[i].ToString().Replace(".", ","));
											break;
										case 14:
