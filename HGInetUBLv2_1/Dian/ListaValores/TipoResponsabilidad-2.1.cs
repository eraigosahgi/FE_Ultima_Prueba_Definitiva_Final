...
namespace HGInetUBLv2_1.DianListas
{
	public class ListaTipoResponsabilidad
	{
		...
		public List<ListaItem> Items = new List<ListaItem>()
		{
			...
			new ListaItem("O-48", "Impuesto sobre las ventas – IVA", "Impuesto sobre las ventas – IVA"),
			new ListaItem("O-49", "No responsable de IVA", "No responsable de IVA"),
			new ListaItem("O-52", "Facturador electrónico", "Facturador electrónico"),
