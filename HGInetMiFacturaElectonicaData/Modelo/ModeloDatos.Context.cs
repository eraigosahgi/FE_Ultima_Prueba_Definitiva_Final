...
namespace HGInetMiFacturaElectonicaData.Modelo
{
    ...
    public partial class ModeloConexion : DbContext
    {
        ...
        public virtual DbSet<QryEmpleados> QryEmpleados { get; set; }
        public virtual DbSet<TblPlanesTransacciones> TblPlanesTransacciones { get; set; }
        public virtual DbSet<TblEventosRadian> TblEventosRadian { get; set; }
        public virtual DbSet<TblAlmacenamientoDocs> TblAlmacenamientoDocs { get; set; }
        public virtual DbSet<TblRegistroRecepcion> TblRegistroRecepcion { get; set; }
        public virtual DbSet<TblImportacionDoc> TblImportacionDoc { get; set; }
        public virtual DbSet<TblProcesoCorreo> TblProcesoCorreo { get; set; }
        public virtual DbSet<TblEmpresaSucursal> TblEmpresaSucursal { get; set; }
        public virtual DbSet<TblEmpresaIntegradores> TblEmpresaIntegradores { get; set; }
        public virtual DbSet<TblIntegradores> TblIntegradores { get; set; }
    }
}
