<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Masters/MasterPrincipal.Master" AutoEventWireup="true" CodeBehind="ConsultaAdministracionPagos.aspx.cs" Inherits="HGInetMiFacturaElectronicaWeb.Views.Pages.ConsultaAdministracionPagos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContenidoPagina" runat="server">
	...
	<script src="../../Scripts/Pages/ConsultaAdministracionPagos.js?vjs20201019"></script>

	<div data-ng-app="PagosAdministracionApp">

		<!-- CONTENEDOR PRINCIPAL -->
		<div data-ng-controller="PagosAdministracionController">
