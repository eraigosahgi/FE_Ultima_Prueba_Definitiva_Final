            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="TabAdministrador">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12" data-ng-if="Panel13511" data-ng-init="Panel13511=true">
                            <div class="panel">
                                <div class="panel-body">
                        ...
                        <div class="col-md-6" data-ng-if="Panel13512" data-ng-init="Panel13512=true">
                            <div class="panel">
                                <div class="panel-body">
                        ...
                        <div class="col-md-6" data-ng-if="Panel13513" data-ng-init="Panel13513=true">
                            <div class="panel">
                                <div class="panel-body">
                        ...
                        <div class="col-md-8" data-ng-if="Panel13514" data-ng-init="Panel13514=true">
                            <div class="panel">
                                <div class="panel-body">
                        ...
                        <div class="col-md-4" data-ng-if="Panel13515" data-ng-init="Panel13515=true">
                            <div class="panel">
                                <div class="panel-body">
                        ...
                        <!-- REPORTE VENTAS -->
                        <div class="col-md-12" data-ng-if="Panel13516" data-ng-init="Panel13516=true">
                            <div class="panel">
                                <div class="panel-body">
                        ...
                        <div class="col-md-6" data-ng-if="Panel13517" data-ng-init="Panel13517=true">
                            <div class="panel">
                                <div class="panel-body">
                        ...
                        <div class="col-md-6" data-ng-if="Panel13518" data-ng-init="Panel13518=true">
                            <div class="panel">
                                <div class="panel-body">
                ...
                <div class="tab-pane" id="TabFacturador">
                    ...
                    <div class="row">
                        ...
                        <!-- REPORTE ESTADOS DOCUMENTO -->
                        <div class="col-md-12" data-ng-if="Panel13521" data-ng-init="Panel13521=true">
                            <div class="panel">
                                <div class="panel-body">
                                    <h4 class="text-bold" style="margin-top: -10px; margin-bottom: 20px">Documentos por Estado</h4>
                        ...
                        <div class="col-md-12" data-ng-if="Panel13522" data-ng-init="Panel13522=true">
                            <div class="panel">
                                <div class="panel-body">
                        ...
                        <!-- REPORTE ESTADO ACUSE MENSUAL -->
                        <div class="col-md-6" data-ng-if="Panel13523" data-ng-init="Panel13523=true">
                            <div class="panel">
                                <div class="panel-body">
                                    <h4 class="text-bold" style="margin-top: -10px; margin-bottom: 20px">Acuse de Respuesta Mes Actual</h4>
                        ...
                        <!-- REPORTE ESTADO ACUSE ACUMULADO-->
                        <div class="col-md-6" data-ng-if="Panel13524" data-ng-init="Panel13524=true">
                            <div class="panel">
                                <div class="panel-body">
                                    <h4 class="text-bold" style="margin-top: -10px; margin-bottom: 20px">Acuse de Respuesta Acumulado</h4>
                        ...
                        <!-- REPORTE TIPO DOCUMENTO ANUAL -->
                        <div class="col-md-8" data-ng-if="Panel13525" data-ng-init="Panel13525=true">
                            <div class="panel">
                                <div class="panel-body">
                                    <h4 class="text-bold" style="margin-top: -10px; margin-bottom: 2px">Tipos de Documento por Mes</h4>
                                    <label class="text-muted" style="margin-bottom: 20px">Indica la cantidad de documentos generados por tipo durante los últimos 12 meses.</label>
                        ...
                        <!-- REPORTE ACUMULADO TIPO DOCUMENTO -->
                        <div class="col-md-4" data-ng-if="Panel13526" data-ng-init="Panel13526=true">
                            <div class="panel">
                                <div class="panel-body">
                                    <h4 class="text-bold" style="margin-top: -10px; margin-bottom: 20px">Tipos de Documento Acumulado</h4>
                ...
                <div class="tab-pane" id="TabAdquiriente">
                    ...
                    <div class="row">
                        ...
                        <!-- REPORTE ESTADO ACUSE ACUMULADO-->
                        <div class="col-md-6" data-ng-if="Panel13531" data-ng-init="Panel13531=true">
                            <div class="panel">
                                <div class="panel-body">
                                    <h4 class="text-bold" style="margin-top: -10px; margin-bottom: 20px">Acuse de Respuesta Acumulado</h4>
                        ...
                        <!-- REPORTE ACUMULADO TIPO DOCUMENTO -->
                        <div class="col-md-6" data-ng-if="Panel13532" data-ng-init="Panel13532=true">
                            <div class="panel">
                                <div class="panel-body">
                                    <h4 class="text-bold" style="margin-top: -10px; margin-bottom: 20px">Tipos de Documento Acumulado</h4>
                        ...
                        <!-- REPORTE TIPO DOCUMENTO ANUAL -->
                        <div class="col-md-6" data-ng-if="Panel13533" data-ng-init="Panel13533=true">
                            <div class="panel">
                                <div class="panel-body">
                                    <h4 class="text-bold" style="margin-top: -10px; margin-bottom: 2px">Tipos de Documento por Mes</h4>
                                    <label class="text-muted" style="margin-bottom: 20px">Indica la cantidad de documentos generados por tipo durante los últimos 12 meses.</label>
