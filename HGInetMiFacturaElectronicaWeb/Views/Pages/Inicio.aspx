    ...
    <div class="col-md-12" data-ng-app="IndicadoresApp" data-ng-controller="IndicadoresController">
        ...
        <div class="panel-body">
            ...
            <ul class="nav nav-tabs">
                <li id="Panel1351" data-ng-if="Panel13511" data-ng-init="Panel13511=true" class="active"><a href="#TabAdministrador" data-toggle="tab">Administrador</a></li>
                <li id="Panel1352" data-ng-if="Panel13511" data-ng-init="Panel13511=true"><a href="#TabFacturador" data-toggle="tab">Facturador</a></li>
                <li id="Panel1353" data-ng-if="Panel13511" data-ng-init="Panel13511=true"><a href="#TabAdquiriente" data-toggle="tab" aria-expanded="false">Adquiriente</a></li>
            </ul>
            <!--  /MENÚ TABS -->
