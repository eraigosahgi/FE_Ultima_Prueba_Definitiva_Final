...
namespace HGInetMiFacturaElectronicaWeb.Controllers.Services
{
	public class PermisosController : ApiController
	{
		...
		/// <returns></returns>
		public IHttpActionResult Get(string codigo_usuario, string codigo_empresa, bool permisos = true)
		{
			try
			{
				...
				var retorno = datos.Select(d => new
				{
					...
					Consultar = (permisos) ? d.IntConsultar : false,
					Agregar = (permisos) ? d.IntAgregar : false,
					Editar = (permisos) ? d.IntEditar : false,
					Eliminar = (permisos) ? d.IntEliminar : false,
					Anular = (permisos) ? d.IntAnular : false,
					Gestion = (permisos) ? d.IntGestion : false
				});
