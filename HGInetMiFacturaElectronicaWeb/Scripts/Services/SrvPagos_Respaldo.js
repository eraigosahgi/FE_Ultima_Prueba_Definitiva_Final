...
var ruta_servicios = 'https://cloudservices.hginet.co/Views/Pago.aspx';
...
apphgi.controller('myCtrl', function ($scope, SrvPagos) {
	...
	function Consultar(ValorIdentificacion, ValorDocumento) {
		...
		$('#tblPagos').hide();
		$.ajax({
			url: ruta + '/api/ConsultarPagosFueraPlataforma2?IdSeguridad=' + $scope.serial + '&identificacion=' + ValorIdentificacion + '&documento=' + ValorDocumento + '&prefijo=' + $scope.Prefijo,
