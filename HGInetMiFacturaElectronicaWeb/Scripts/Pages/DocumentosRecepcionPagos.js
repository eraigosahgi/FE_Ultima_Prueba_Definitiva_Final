...
App.controller('DocRecepcionPagosController', function ($scope, $rootScope, $http, $location, SrvMaestrosEnum, SrvFiltro) {
	...
	function consultar2() {
		...
		$('#wait').show();
		$http.get('/api/ObtenerDocumentosRecepcionPagos?codigo_facturador=' + codigo_facturador + '&codigo_adquiente=' + codigo_adquiente + '&numero_documento=' + numero_documento + '&estado_recibo=' + estado_recibo + '&fecha_inicio=' + fecha_inicio + '&fecha_fin=' + fecha_fin + '&tipo_filtro_fecha=' + tipo_filtro_fecha).then(function (response) {
			$('#wait').hide();
