								...
								customizeTooltip: function (arg) {
									...
									if (datos.length > 0) {
										if (arg.seriesName == "Facturas")
											mensaje = "Facturas" + "<br/>" + "Mes: " + arg.argument + "<br/>" + "Año: " + datos[0].Anyo + "<br/>" + "Cantidad: " + datos[0].CantidadFacturas + "<br/>" + "Valor: " + fNumber.go(datos[0].ValorFacturas);
										else if (arg.seriesName == "Notas Crédito")
											mensaje = "Notas Crédito" + "<br/>" + "Mes: " + arg.argument + "<br/>" + "Año: " + datos[0].Anyo + "<br/>" + "Cantidad: " + datos[0].CantidadNotasCredito + "<br/>" + "Valor: " + fNumber.go(datos[0].ValorNotasCredito);
										else if (arg.seriesName == "Notas Débito")
											mensaje = "Notas Débito" + "<br/>" + "Mes: " + arg.argument + "<br/>" + "Año: " + datos[0].Anyo + "<br/>" + "Cantidad: " + datos[0].CantidadNotasDebito + "<br/>" + "Valor: " + fNumber.go(datos[0].ValorNotasDebito);
									}
