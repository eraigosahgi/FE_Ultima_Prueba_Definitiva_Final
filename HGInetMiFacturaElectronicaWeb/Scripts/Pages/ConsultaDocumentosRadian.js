...
var UsuarioSession = "";
App.controller('DocRadianController', function DocRadianController($scope, $http, $location, SrvMaestrosEnum, SrvDocumento, $rootScope, SrvFiltro) {
	var now = new Date();
	var Estado;
	...
	function consultarDatos() {
		...
		$http.get('/api/ObtenerDocumentosRadian?numero_documento=' + numero_documento + '&codigo_adquiriente=' + codigo_adquiriente + '&fecha_inicio=' + fecha_inicio + '&fecha_fin=' + fecha_fin + '&resolucion=' + resolucion + '&tipo_filtro_fecha=' + tipo_filtro_fecha).then(function (response) {
			$('#wait').hide();
