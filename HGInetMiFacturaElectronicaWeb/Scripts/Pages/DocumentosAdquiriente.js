...
App.controller('DocAdquirienteController', function DocAdquirienteController($scope, $rootScope, $http, $location, SrvMaestrosEnum) {
...
App.controller('ModalPagosController', function ModalPagosController($scope, $rootScope, $location, $http, $timeout) {
