                   ...
                   , columns: [
                       {
                       	...
                       	cellTemplate: function (container, options) {
                       		var EditarSerial = "";
                       		if (options.data.ConsultaAdmin) {
                       			EditarSerial = "<a class='icon-pencil3' data-toggle='modal' data-target='#modal_Serial_empresa' style='margin-left:12%; font-size:19px'></a>";
                       		}
