...
DocObligadoApp.controller('DocObligadoController', function DocObligadoController($scope, $http, $location, SrvMaestrosEnum, SrvDocumento, $rootScope) {
	...
	ConsultarAuditoria = function (IdSeguridad) {
		$rootScope.ConsultarAuditDoc(IdSeguridad);
	};
...
DocObligadoApp.controller('ModalAuditDocumentoController', function ModalAuditDocumentoController($http, $scope, $location, $rootScope) {
	...
	$rootScope.ConsultarAuditDoc = function (IdSeguridad) {
