...
var UsuarioSession = "";
App.controller('ConsultaDocumentoSoporteController', function ConsultaDocumentoSoporteController($scope, $http, $location, SrvMaestrosEnum, SrvDocumento, $rootScope, SrvFiltro) {
	var now = new Date();
	var Estado;
