...
namespace HGInetFeAPI
{
	public class Ctl_PagosElectronicos
	{
		...
		/// <summary>
		/// Permite consultar el resultado de los pagos en la plataforma por el Facturador Electrónico agrupados por Ciclo PSE e individuales cuando es Tarjeta de Credito		
		/// </summary>
		/// <param name="UrlWs">ruta principal de ejecución del servicio web HGI Facturación Electrónica (http)</param>
		/// <param name="Serial">serial de licenciamiento para HGI Facturación Electrónica</param>
		/// <param name="Identificacion">número de identificación del Facturador Electrónico</param>
		...
		/// <param name="Procesados"></param>
		/// <returns>indica el Pago fue procesado o no: 0 Todos Los Pagos, 1 Pagos Procesados, 2 Pagos que aun no se han Procesado</returns>
		public static List<ServicioPagosElectronicos.PagoElectronicoRespuestaAgrupadoPorFecha> ConsultaAgrupadosPorFechaElaboracion(string UrlWs, string Serial, string Identificacion, DateTime FechaInicial, DateTime FechaFinal, int Procesados = 0)
		{
			...
			List<ServicioPagosElectronicos.PagoElectronicoRespuestaAgrupadoPorFecha> datos = new List<ServicioPagosElectronicos.PagoElectronicoRespuestaAgrupadoPorFecha>();
			...
			try
			{
				...
				// datos para la petición
				ServicioPagosElectronicos.ConsultaAgrupadosPorFechaElaboracionRequest peticion = new ServicioPagosElectronicos.ConsultaAgrupadosPorFechaElaboracionRequest()
				{
					DataKey = dataKey,
					Identificacion = Identificacion,
					FechaInicial = FechaInicial,
				...
				// ejecución del servicio web
				ServicioPagosElectronicos.ConsultaAgrupadosPorFechaElaboracionResponse respuesta = cliente_ws.ConsultaAgrupadosPorFechaElaboracion(peticion);

				// resultado del servicio web
				List<ServicioPagosElectronicos.PagoElectronicoRespuestaAgrupadoPorFecha> result = respuesta.ConsultaAgrupadosPorFechaElaboracionResult;
