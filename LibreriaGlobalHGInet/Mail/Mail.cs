...
namespace LibreriaGlobalHGInet.General
{
	...
	public class Mail
	{
		...
		public Mail(bool uno_a_uno, MailAddress correo_desde, MailAddressCollection correos_destino, MailAddressCollection correos_copia = null, MailAddressCollection correos_copia_oculta = null)
		{
		...
		/// <param name="correos_copia">destinatarios de copia</param>
		/// <param name="correos_copia_oculta">destinatarios de copia oculta</param>
		public Mail(bool uno_a_uno, SmtpClient cliente, MailAddress correo_desde, MailAddressCollection correos_destino, MailAddressCollection correos_copia = null, MailAddressCollection correos_copia_oculta = null)
		{
			this.uno_a_uno = uno_a_uno;
				...
				using (MailMessage correo = new MailMessage())
				{
					...
					if (rutas_adjuntos != null)
					{
						...
						else
						{
							foreach (string ruta_adjunto in rutas_adjuntos)
							{
								ArchivoUrl archivo_memoria = Archivo.Obtener(ruta_adjunto);
